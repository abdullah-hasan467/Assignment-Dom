function PlayGame() {
    ...
    page.innerText = generateAlphabet.toUpperCase();  // Set the text to the generated letter in uppercase
}
...
function RandomAlphabet() {
    ...
    const alphabetAndIndex = alphabets[index];  // Get the alphabet at the random index
